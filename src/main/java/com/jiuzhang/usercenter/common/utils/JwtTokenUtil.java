package com.jiuzhang.usercenter.common.utils;
...
import com.jiuzhang.usercenter.common.exception.CustomException;
import com.jiuzhang.usercenter.common.token.Audience;
...
public final class JwtTokenUtil {
    ...
    public static String createJWT(String userId, String username) {
        ...
        try {
            ...
            // 添加构成JWT的参数
            JwtBuilder builder = Jwts.builder().setHeaderParam("typ", "JWT").claim("userId", userId)
                    // 代表这个JWT的主体，即它的所有人
                    .setSubject(username)
                    // 代表这个JWT的签发主体；
                    ...
                    // 代表这个JWT的接收对象；
                    .setAudience(audience.getName()).signWith(signatureAlgorithm, signingKey);
            // 添加Token过期时间
